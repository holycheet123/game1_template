...
def remove_punct(text):
    """This function is used to rove all punctuation
    ...
    'goSouTh'
    """
    a = text.translate(None, string.punctuation)
    return a
...
def normalise_input(user_input):
    ...
    'help'
    """
    a = user_input.translate(None, string.punctuation)
    b = a.strip()
    c = b.lower()
    return c
    pass
...
def print_menu(exits):
    ...
    print("You can:")
    for key in exits:
        a = exit_leads_to(exits, key) 
        print_menu_line(key, a)
...
def is_valid_exit(exits, user_input):
    ...
    True
    """
    if exits.has_key(user_input) == True:
        return True
    else:
        return False
